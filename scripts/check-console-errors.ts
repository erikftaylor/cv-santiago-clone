 ...
 *   Production: npx tsx scripts/check-console-errors.ts https://${site.domain}
 *
...
function getUrls(): string[] {
  ...
  urls.push(site.url('/privacidad'), site.url('/privacy'))

  // Convert to use the base URL
  return urls.map(url => url.replace(site.origin, baseUrl))
}
