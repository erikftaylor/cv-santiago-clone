/**
 * WFG 365 mobile-app case study page. Built from the shared article
 * primitives — see src/articles/components.tsx and content-types.tsx.
 * No MetricsGrid: adoption metrics were never formally tracked, so `results`
 * renders as prose + a BulletList of qualitative factors instead.
 */
import { type Wfg365Lang as Lang, wfg365Content } from './wfg365-i18n'
...
export default function Wfg365CaseStudy({ lang }: { lang: Lang }) {
  const t = wfg365Content[lang]

  const jsonLd = buildJsonLdFromRegistry('wfg365-case-study', lang, {
    header: { h1: t.h1 },
  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <ArticleFooter lang={lang} utmCampaign="wfg365-case-study" editorId="wfg365-footer" />
    </ArticleLayout>
  )
}
