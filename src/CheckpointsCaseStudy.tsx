/**
 * Checkpoints go/no-go discovery case study page. Built from the shared
 * article primitives — see src/articles/components.tsx and content-types.tsx.
 */
import { type CheckpointsLang as Lang, checkpointsContent } from './checkpoints-i18n'
...
export default function CheckpointsCaseStudy({ lang }: { lang: Lang }) {
  const t = checkpointsContent[lang]

  const jsonLd = buildJsonLdFromRegistry('checkpoints-case-study', lang, {
    header: { h1: t.h1 },
  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <ArticleFooter lang={lang} utmCampaign="checkpoints-case-study" editorId="checkpoints-footer" />
    </ArticleLayout>
  )
}
